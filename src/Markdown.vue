<template>
    <div class="c-editor-markdown">
        ...
        <mavon-editor class="c-markdown" ref="md" :xssOptions="xssOptions" v-model="data" :editable="editable" :navigation="false" @change="updateData" :subfield="false" :readOnly="readOnly">
